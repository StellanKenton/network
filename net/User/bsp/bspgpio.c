...
static const stBspGpioMap gBspGpioMap[DRVGPIO_MAX] = {
	...
	[DRVGPIO_CELLULAR_PWRKEY] = {GPIOA, GPIO_Pin_10, 1U, GPIO_PuPd_NOPULL, DRVGPIO_PIN_RESET},
	[DRVGPIO_CELLULAR_RESET] = {GPIOD, GPIO_Pin_4, 1U, GPIO_PuPd_NOPULL, DRVGPIO_PIN_SET},
	[DRVGPIO_FLASH_CS] = {GPIOC, GPIO_Pin_13, 1U, GPIO_PuPd_UP, DRVGPIO_PIN_SET},
	...
	[DRVGPIO_TCA9535_SCL] = {GPIOD, GPIO_Pin_11, 1U, GPIO_PuPd_UP, DRVGPIO_PIN_SET},
	[DRVGPIO_TCA9535_SDA] = {GPIOD, GPIO_Pin_12, 1U, GPIO_PuPd_UP, DRVGPIO_PIN_SET},
	[DRVGPIO_TCA9535_INT] = {GPIOD, GPIO_Pin_13, 0U, GPIO_PuPd_UP, DRVGPIO_PIN_RESET},
	[DRVGPIO_CELLULAR_VERSION] = {GPIOB, GPIO_Pin_4, 0U, GPIO_PuPd_UP, DRVGPIO_PIN_RESET},
	[DRVGPIO_TCA9535_RESET] = {GPIOD, GPIO_Pin_7, 1U, GPIO_PuPd_NOPULL, DRVGPIO_PIN_SET},
};
